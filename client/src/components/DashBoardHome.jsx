...
import { GiLoveSong, GiMusicalNotes , GiBookCover} from "react-icons/gi";
...
const DashBoardHome = () => {
  ...
  return (
    <div className="w-full p-6 flex items-center justify-evenly flex-wrap">
      ...
      {/* prettier-ignore */}
      <DashboardCard icon={<GiBookCover className="text-3xl text-textColor" />} name={"Books"} count={allSongs?.length > 0 ? allSongs?.length : 0} />
